...
def build_report_html(
    ...
    report_parts = [
        ...
        "<span class='export-filter-title'>Exportfilter:</span>",
        "<label class='ui5-checkbox'><input class='export-status-filter' type='checkbox' value='same' checked>Übereinstimmungen</label>",
        "<label class='ui5-checkbox'><input class='export-status-filter' type='checkbox' value='different' checked>Abweichungen</label>",
        "<label class='ui5-checkbox'><input class='export-status-filter' type='checkbox' value='missing' checked>Fehlende</label>",
        "<label class='ui5-checkbox'><input class='export-status-filter' type='checkbox' value='diff'>Diff</label>",
        "</div>",
        "<label class='ui5-checkbox'><input id='export-visible-only' type='checkbox'>Tabellenfilter zusätzlich übernehmen</label>",
        "</div>",
        "</div>",
        "<div class='ui5-kpis'>",
